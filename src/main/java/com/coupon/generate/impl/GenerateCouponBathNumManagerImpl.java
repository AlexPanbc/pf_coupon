...
@Component("GenerateCouponBathNumManagerImpl")
public class GenerateCouponBathNumManagerImpl implements GenerateNumberManager {
    ...
    private String buildSeqIdCacheKey() {
        return "coupon_bath_SeqId:" + new SimpleDateFormat("yyyyMMdd").format(new Date());
    }
