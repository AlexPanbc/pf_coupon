 ...
 */
@Component("GenerateConfirmationNumberManagerImpl")
public class GenerateConfirmationNumberManagerImpl implements GenerateNumberManager {
    ...
    public String nextId() {
        ...
        // 1511107200000L => 2017-11-20 0:0:0
        int day = (int) ((date.getTime() - 1511107200000L) / 1000 / 60 / 60 / 24);
    ...
    public String buildString(int day, char rndCh, Long sequenceId) {
        ...
        char part3;
        int part3_RndNum = ThreadLocalRandom.current().nextInt(10); // 生成一个 0~10(不含10)之间的随机数，用于获取一个字符
